...
class PyJwtVerifier:
    ...
    def __init__(
        ...
        **custom_claims,
        ...
        self.message = (
            self.header.encode("ascii") + b"." + self.payload.encode("ascii")
        )  ## will be used to obtain the computed hash
    ...
    def return_payload(self):
        ...
        return {"header": self.decoded_header, "payload": self.decoded_payload}
